    ...
    def extract_car_details(self, html_content, url):
        ...
        for item in info_items:
            ...
            if label_elem and value_elem:
                ...
                elif 'Số cửa' in label:
                    car_data['doors'] = int(value) if value.isdigit() else None
                elif 'Phiên bản xe' in label:
                    car_data['version'] = value
                elif 'Tình trạng' in label:
                    car_data['condition'] = value
                elif 'Hệ dẫn động' in label:
                    car_data['drivetrain'] = value
                elif 'Kiểu động cơ' in label:
                    car_data['engine_type'] = value
                elif 'Công suất động cơ' in label:
                    car_data['horse_power'] = value
                elif 'Momen xoắn' in label:
                    car_data['torque'] = value
                elif 'Dung tích động cơ' in label:
                    car_data['engine_capacity'] = value
                elif 'Nhiên liệu tiêu thụ' in label:
                    car_data['fuel_consumption'] = value
                elif 'Số túi khí' in label:
                    car_data['air_bags'] = value
                elif 'Khoảng sáng gầm xe' in label:
                    car_data['ground_clearance'] = value
